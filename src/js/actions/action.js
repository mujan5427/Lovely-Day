...
export const ENABLE_DISPLAY_NAVIGATION            = 'ENABLE_DISPLAY_NAVIGATION';
...
export function enableDisplayDropDownMenuNavigation() {
  return {
    type: ENABLE_DISPLAY_NAVIGATION
  };
}

export function disableDisplayDropDownMenuNavigation() {
  return {
    type: DISABLE_DISPLAY_NAVIGATION
  };
}

export function enableDisplayDropDownMenuPersonalInformation() {
  return {
    type: ENABLE_DISPLAY_PERSONAL_INFORMATION
  };
}
